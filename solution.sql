...
/* --3. The bank is giving a new customer bonus! Update all records with an account balance of 0.00
...
VALUES ('emily',  'st paul', '5', '7', '50.00');
...
SELECT * FROM "syntax_practice" WHERE ("city" ILIKE 'Miami' OR "city" ILIKE 'Phoenix') AND transactions_completed <5;
